...
A powerful and user-friendly tool to scrape marriage vendor data (such as Halls, Caterers, Photographers) from **Justdial** and **Google Maps**. This application features a Streamlit-based UI for easy interaction, data visualization, and export capabilities.

## Features

-   **Multi-Source Scraping**: Scrape data from Justdial and Google Maps.
...
2.  **Navigate the UI**
    ...
    -   **Categories**: Select the vendor types you need (e.g., `Halls`, `Catering`).
